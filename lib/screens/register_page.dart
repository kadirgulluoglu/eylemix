              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: buildTextField(nameController,
                              LocaleKeys.Register_Name.tr(), false)),
                      Expanded(
                          child: buildTextField(surnameController,
                              LocaleKeys.Register_Surname.tr(), false)),
                    ],
                  ),
                  const SizedBox(
                    height: 20.0,
                  ...
                  buildTextField(
                      emailController, LocaleKeys.Register_email.tr(), false),
                  const SizedBox(
                    height: 20.0,
                  ),
                  ...
                  buildTextField(passwordController,
                      LocaleKeys.Register_Password.tr(), true),
                  const SizedBox(
                    height: 20.0,
                  ),
                  buildTextField(confirmPasswordController,
                      LocaleKeys.Register_ConfirmPassword.tr(), true),
                  const SizedBox(
                    height: 20.0,
                  ),
