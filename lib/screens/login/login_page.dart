        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              IconButton(
                icon: Icon(
                  isPlaying ? Icons.hearing_disabled : Icons.hearing,
                  color: Colors.white,
                ),
                iconSize: 64,
              ...
              buildTextField(Icons.email, emailController,
                  LocaleKeys.Login_Page_email.tr(), false),
              const SizedBox(
                height: 20.0,
              ),
              buildTextField(Icons.lock, passwordController,
                  LocaleKeys.Login_Page_password.tr(), true),
              const SizedBox(
                height: 40.0,
              ),
